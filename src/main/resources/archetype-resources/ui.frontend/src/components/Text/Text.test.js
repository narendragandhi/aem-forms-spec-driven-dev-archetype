...
describe('Text ->', () => {
  ...
  it('should render the text component with no parameter', () => {
    ...
    expect(
      container.querySelector(RTE_EDIT_ELEMENT_DATA_ATTR_SELECTOR)
    ).toBeNull();
  });

  it('should render the text component that contains the provided text as a string', () => {
    const { container } = render(<Text text={TEXT_DATA} />);
    ...
    expect(container.firstChild.innerHTML).toContain(TEXT_DATA_STR);
  });

  it('should render the text component that contains the provided text as a DOM structure', () => {
    const { container } = render(<Text text={TEXT_DATA} richText={true} />);
    ...
    expect(container.querySelector('.' + TEXT_DATA_CLASS_NAME).innerHTML).toBe(
      TEXT_DATA_STR
    );
  });

  it('should render the text as a rich text component', () => {
    const { container } = render(<Text richText={true} />);
  ...
  it('should render the text as a rich text component with a given id', () => {
    const { container } = render(<Text cqPath={CONTENT_PATH} richText={true} />);
    ...
    expect(
      container.querySelector('#' + extractModelId(CONTENT_PATH))
    ).not.toBeNull();
  });
});
